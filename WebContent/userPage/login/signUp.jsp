...
<form name="signUp" action="signUpPro.jsp" method= "post" onsubmit="return loginNext();">
  <div class="signUp">
    <h1>회원가입</h1>
    <hr>
  ...
  <table width='800'>
   ...
   <tr> 	
	...
	<tr> 	
    	<td width='200'><label for="address"><b>휴대폰 번호</b></label></td>
    	<td width='600' colspan='2'><input type="number" name="ph1" maxlength="4" required value="010">-
    								<input type="number" name="ph2" maxlength="4" required>-
    								<input type="number" name="ph3" maxlength="4" required><br/></td>
	</tr>
	<tr>
		<td colspan="3">
   		<div class="clearfix">
      	<button type="button" class="cancelbtn" onclick="window.location='/badgudu/userPage/main.jsp'">취소</button>
