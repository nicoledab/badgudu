...
<%
    ...
    count = dbPro.getArticleCount(col,search); // 전체 게시물 수를  dbPro의 ArticleCount() 메서드에서 가져옴
...
<%if (count == 0) {%>
	<table width="700" border="1" cellpadding="0" cellspacing="0">
		<tr>
    		<td align="center">
    			게시판에 저장된 글이 없습니다. <%System.out.println(%><%search); %>
    		</td>
    	</tr>
	</table>

<%  } else {    %>
<table class=" table-dark  table-hover" width="1200" align="center"> 	<!-- 줄마다의 여백 등의 옵션..디자인 -->
	<tr height="30""> 
