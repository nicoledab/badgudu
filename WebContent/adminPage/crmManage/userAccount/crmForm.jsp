...
<%
    ...
    count = dbPro.usergetArticleCount();
	
    if (count > 0) {
        articleList = dbPro.usergetArticles(startRow, endRow);
    }
...
<table width="700">
   <tr>
       <td align="right">
          ...
          %>
             <a href="/badgudu/userPage/user/LoginForm.jsp">로그인후 고객관리</a>
          <%
          }
          %>
       </td>
