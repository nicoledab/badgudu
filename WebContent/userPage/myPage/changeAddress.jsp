...
<form name = "changeAddress" action="changeAddressPro.jsp" method="post">

<table>

    <tr align='center' height='50'> 	
    	<td width='300'><label for="address"><b>주소</b></label></td>
    	<td width='300'><input type="text" placeholder="주소 입력" name="address" value="<%=dto.getAddress()%>"required><br/></td>
	</tr >
	<tr align='center' height='50'>
