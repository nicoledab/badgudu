...
<%
    ...
    count = dbPro.admingetArticleCount(col,search);
	
    if (count > 0) {
    	articleList = dbPro.admingetArticles(col, search, startRow, endRow);
    }
...
<html>
<head>
<title>관리자목록페이지</title>

<link href="style.css" rel="stylesheet" type="text/css">
</head>

<body>
<center><b>관리자목록(전체 관리자:<%=count%>)</b>
<table width="700">
