...
String idOdCheck = dao.idOdCheck(id,pdcode);
    ...
    <%--
       <input type="text" size="40" maxlength="50" name="subject"></td>
        --%>
            ...
            <option value="subject">루시아 앵클 삭스 스니커즈<option> 
            <option value="subject">골지 데일리 돌돌이 양말<option> 
            <option value="subject">휘트니 격자 슬링백<option> 
            <option value="subject">리브 스퀘어 버클 플랫<option> 
            <option value="subject">폴리 스틸레토 뮬 샌들<option> 
            <option value="subject">소다 키높이 스니커즈<option> 
            <option value="subject">샌디뉴 통굽 스니커즈<option>    </select>
