...
<div id="qnalist" style=" float:left;">
...
<jsp:include page="Header.jsp"/> 
    ...
    <%--반품문의 기타문의  class="table table-striped"   width = "1200" --%>
...
<%}else{%>     
  ...
  <tr>
    <th>번호</th> <th>문의 종류 </th><th >제목</th> <th>작성자</th>   <th>날짜</th><th>조회수</th>
  </tr>
...
<%if(id != null){ %>
    			<input type="button"  value="글쓰기" onclick="window.location='qwriteForm.jsp'"  />
    		<%}else{%>
    		<input type="button"  value="로그인 후 글쓰기" onclick="window.location='/badgudu/userPage/login/loginForm.jsp'"  />
    		<%}%>
   --%> 
...
<%--</div> <%@ include file ="/userPage/bottom.jsp" %>--%>
