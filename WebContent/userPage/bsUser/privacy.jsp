...
<table width="100%">
	...
	<tr>
		<td>ㅤ</td>
		<td><center><h1>개인정보 보호정책</h1></center></td>
	</tr>
	<tr>
		<td>ㅤ</td>
	</tr>
	...
	<tr>
		<td>ㅤ</td>
		<td> <center><textarea rows="100%" cols="100%">(주)45스페이스는 (이하 "회사"는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
...
o 위탁 대상자 : ㈜스냅컴퍼니(알림전송수탁업체 : ㈜엠티에스컴퍼니)
...
#“(주)45스페이스(착한구두)”는 서비스 향상을 위해 관계법령에 따라 회원의 동의를 얻거나 관련 사항을 공개 또는 고지 후 회원의 개인정보를 외부에 위탁하여 처리하고 있습니다. “(주)45스페이스(착한구두)”의 개인정보처리 수탁자와 그 업무의 내용은 다음과 같습니다.
...
- 위탁 업무 내용 : 네이버 알림 서비스 제공


■ 이용자 및 법정대리인의 권리와 그 행사방법
o 이용자 및 법정대리인은 언제든지 등록되어 있는 자신의 개인정보를 조회하거나 수정할 수 있으며 가입해지를 요청할 수도 있습니다.
o 이용자 및 법정대리인들의 개인정보 조회,수정을 위해서는 "개인정보변경"(또는 "회원정보수정" 등)을 가입해지(동의철회)를 위해서는 "회원탈퇴"를 클릭하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다.
...
② 제 1항에 따른 권리 행사는 회사에 대한 서면, 전화, 전자우편, 모사전송(FAX)등을 통하여 하실 수 있으며 회사는 이에 대해 지체 없이 조치하겠습니다.

③ 정보주체가 개인정보의 오류 등에 대한 정정 또는 삭제를 요구한 경우에는 회사는 정정 또는 삭제를 완료할 때까지 당해 개인정보를 이용하거나 제공하지 않습니다.

④ 제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보 보호법 시행규칙 별지 제11호 서식에 따른 위임장을 제출하셔야합니다.
...
경찰청 사이버안전국 (www.ctrc.go.kr/ 국번 없이 182)</textarea></center> </td>
	</tr>
